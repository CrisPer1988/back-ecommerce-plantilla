Este es un proyecto desarrollado conjuntamente por un grupo de gente que le encanta desarrollo web.
...
- [Trello: Tareas del Proyecto](https://trello.com/b/QRkM9Uze/ecommerce)
...
- Al hacer cambios realiza pruebas antes de enviar.
...
```bash
git clone https://github.com/CrisPer1988/back-ecommerce-plantilla/
```
...
- El siguiente paso es elegir una tarea para trabajar en ella. Puedes encontrar tareas en [Trello del Proyecto](https://trello.com/b/QRkM9Uze/ecommerce).

### 📂 Crear una rama

- Crea una nueva rama desde la rama principal (main) utilizando un nombre descriptivo que indique el problema que estás solucionando. Por ejemplo:
...
- Ejecutar `pretier` antes de enviar o subir tu rama.
- Si tienes conflictos elimina tu Pull Request, revisa tu código, vuelve a ejecutar; actualiza tu rama y envia una Pull Request a la rama correspondiente.

- Envía un Pull Request a la rama del repositorio original con tu nueva rama. Asegúrate de proporcionar una descripción clara y detallada de los cambios que has realizado y por qué son importantes.
